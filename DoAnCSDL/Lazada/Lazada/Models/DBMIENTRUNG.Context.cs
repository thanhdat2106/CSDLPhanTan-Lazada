...
namespace Lazada.Models
{
    ...
    public partial class QL_LAZADA_MIENTRUNG : DbContext
    {
        public QL_LAZADA_MIENTRUNG()
            : base("name=QL_LAZADA_MIENTRUNG")
        {
        }
        ...
        public DbSet<MSmerge_conflict_MIEN_TRUNG_CT_HOADON> MSmerge_conflict_MIEN_TRUNG_CT_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_HOADON> MSmerge_conflict_MIEN_TRUNG_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_KHACHHANG> MSmerge_conflict_MIEN_TRUNG_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_KHUVUC> MSmerge_conflict_MIEN_TRUNG_KHUVUC { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_LOAIHANG> MSmerge_conflict_MIEN_TRUNG_LOAIHANG { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_NHACUNGCAP> MSmerge_conflict_MIEN_TRUNG_NHACUNGCAP { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_SANPHAM> MSmerge_conflict_MIEN_TRUNG_SANPHAM { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_sysdiagrams> MSmerge_conflict_MIEN_TRUNG_sysdiagrams { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_TK_KHACHHANG> MSmerge_conflict_MIEN_TRUNG_TK_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIEN_TRUNG_TK_NCC> MSmerge_conflict_MIEN_TRUNG_TK_NCC { get; set; }
