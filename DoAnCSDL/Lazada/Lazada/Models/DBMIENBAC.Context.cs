...
namespace Lazada.Models
{
    ...
    public partial class QL_LAZADA_MIENBAC1 : DbContext
    {
        public QL_LAZADA_MIENBAC1()
            : base("name=QL_LAZADA_MIENBAC1")
        {
        }
        ...
        public DbSet<MSmerge_conflict_MIEN_BAC_CT_HOADON> MSmerge_conflict_MIEN_BAC_CT_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_HOADON> MSmerge_conflict_MIEN_BAC_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_KHACHHANG> MSmerge_conflict_MIEN_BAC_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_KHUVUC> MSmerge_conflict_MIEN_BAC_KHUVUC { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_LOAIHANG> MSmerge_conflict_MIEN_BAC_LOAIHANG { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_NHACUNGCAP> MSmerge_conflict_MIEN_BAC_NHACUNGCAP { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_SANPHAM> MSmerge_conflict_MIEN_BAC_SANPHAM { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_sysdiagrams> MSmerge_conflict_MIEN_BAC_sysdiagrams { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_TK_KHACHHANG> MSmerge_conflict_MIEN_BAC_TK_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIEN_BAC_TK_NCC> MSmerge_conflict_MIEN_BAC_TK_NCC { get; set; }
