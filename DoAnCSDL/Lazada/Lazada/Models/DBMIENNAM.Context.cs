...
namespace Lazada.Models
{
    ...
    public partial class QL_LAZADA_MIENNAM : DbContext
    {
        public QL_LAZADA_MIENNAM()
            : base("name=QL_LAZADA_MIENNAM")
        {
        }
        ...
        //public DbSet<MSmerge_conflict_MIEN_NAM_CT_HOADON> MSmerge_conflict_MIEN_NAM_CT_HOADON { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_HOADON> MSmerge_conflict_MIEN_NAM_HOADON { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_KHACHHANG> MSmerge_conflict_MIEN_NAM_KHACHHANG { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_KHUVUC> MSmerge_conflict_MIEN_NAM_KHUVUC { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_LOAIHANG> MSmerge_conflict_MIEN_NAM_LOAIHANG { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_NHACUNGCAP> MSmerge_conflict_MIEN_NAM_NHACUNGCAP { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_SANPHAM> MSmerge_conflict_MIEN_NAM_SANPHAM { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_sysdiagrams> MSmerge_conflict_MIEN_NAM_sysdiagrams { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_TK_KHACHHANG> MSmerge_conflict_MIEN_NAM_TK_KHACHHANG { get; set; }
        //public DbSet<MSmerge_conflict_MIEN_NAM_TK_NCC> MSmerge_conflict_MIEN_NAM_TK_NCC { get; set; }
